...
/// @DnDHash : 6BAAA458
	...
	if(facing == 2){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
		...
		/// @DnDParent : 1FD0EEC3
		/// @DnDArgument : "imageind_relative" "1"
		/// @DnDArgument : "spriteind" "Idle_forward"
		/// @DnDSaveInfo : "spriteind" "Idle_forward"
	...
	/// @DnDParent : 6BAAA458
		...
		/// @DnDParent : 7C4C9AA8
			...
			if(facing == 4){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
				...
				/// @DnDParent : 0439A82C
				/// @DnDArgument : "imageind_relative" "1"
				/// @DnDArgument : "spriteind" "Idle_backward"
				/// @DnDSaveInfo : "spriteind" "Idle_backward"
				sprite_index = Idle_backward;
				image_index += 0;}}}}